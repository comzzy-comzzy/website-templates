...
scripts/generate-manifest.js   scans templates/, writes data/templates.json
```
...
sorting, and pagination for any number of entries.

## Notes

- `data/templates.json` is generated — re-run the script after adding,
  removing, or editing template folders instead of editing the JSON by hand.
